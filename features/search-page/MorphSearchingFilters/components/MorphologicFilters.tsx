...
/**
 * Если значений фильтров в списке больше MULTIPLE_SELECT_THRESHOLD
 * то будет рендерится компонент {@link MultipleSelect}
 */
...
export const MorphologicFilters: FC = () => {
  ...
  return (
    <Disclosure label={t("morfologicheskie-filtry")} disabled={isLoading || Boolean(error)}>
      {filtersData?.filters && (
