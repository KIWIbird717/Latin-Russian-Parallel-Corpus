...
import { badgeIntents, badgeShapes, badgeStyles } from "@/shared/ui/intent/ui/badge";
        ...
        return (
          <>
            ...
            {allowsRemoving && (
              <Button
                slot="remove"
                className="-mr-0.5 grid size-3.5 cursor-pointer place-content-center rounded outline-hidden transition duration-75 [&>[data-slot=icon]]:size-3 [&>[data-slot=icon]]:shrink-0"
              >
                <IconX />
              </Button>
            )}
