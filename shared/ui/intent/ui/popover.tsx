...
import type {
  ...
  DialogHeaderProps,
  DialogTitleProps,
} from "@/shared/ui/intent/ui/dialog";
import {
  Dialog,
  DialogBody,
  DialogClose,
...
const content = tv({
  base: [
    "peer/popover-content max-w-xs rounded-xl border border-border-stroke bg-overlay bg-clip-padding text-overlay-fg shadow-xs transition-transform sm:max-w-3xl sm:text-sm forced-colors:bg-[Canvas]",
  ],
  variants: {
    isPicker: {
