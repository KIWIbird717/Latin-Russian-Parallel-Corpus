...
import { DropdownItem, DropdownLabel, DropdownSection } from "@/shared/ui/intent/ui/dropdown";
import {
  Description,
  FieldGroup,
  type FieldProps,
  Input,
  Label,
} from "@/shared/ui/intent/ui/field";
import { ListBox } from "@/shared/ui/intent/ui/list-box";
import { PopoverContent } from "@/shared/ui/intent/ui/popover";
import {
  ...
  type TagGroupProps,
  TagList,
} from "@/shared/ui/intent/ui/tag-group";
        ...
        <>
          ...
          >
            ...
            >
              ...
              >
                <ListBox
                  className={cn("shadow-0 max-h-[inherit] min-w-[inherit] border-0")}
                  renderEmptyState={() =>
                    renderEmptyState ? (
                      ...
                      <Description className="block p-3">
                        {inputValue ? (
                          <>
                            ...
                            <strong className="text-fg font-medium">{inputValue}</strong>
                          </>
                        ) : (
                          "No options"
                        )}
